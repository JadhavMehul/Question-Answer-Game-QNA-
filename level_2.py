...
box_2=w.create_rectangle(1150,335,1160,345,fill="white")
...
qtag=w.create_text(690,430,text="When did India Won First Cricket World Cup?",fill="orange",font=("Italic",27))

#</question_tag>

# <answer_tag >

ans_tag_A=Button(w,text="A : 1987                        ",bg="black",fg="orange",font=("Italic",19),command = end)
ans_tag_A.place(x=330,y=505)

ans_tag_B=Button(w,text="B : 2011                          ",bg="black",fg="orange",font=("Italic",19),command = end)
ans_tag_B.place(x=750,y=505)

ans_tag_C=Button(w,text="C : 1983                        ",bg="black",fg="orange",font=("Italic",19),command = next3)
ans_tag_C.place(x=330,y=610)

ans_tag_D=Button(w,text="D : 1979                          ",bg="black",fg="orange",font=("Italic",19),command = end)
